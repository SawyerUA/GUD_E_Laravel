    ...
    <div class="container reg-form">
        ...
        <form class="row justify-content-center" method="post" action="{{route('register')}}">
            ...
            <div class="mb-3 col-12 col-md-4">
                ...
                <input type="text" class="form-control" id="name" placeholder="введите ваш логин" name="name" value="">
            </div>
            <div class="w-100"></div>
            <div class="mb-3 col-12 col-md-4">
                <label for="email-inp" class="form-label">Ваш email</label>
                <input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="введите ваш email" name="email" value="">
