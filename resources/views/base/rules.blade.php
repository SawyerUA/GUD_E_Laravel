        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-1 d-none d-md-block align-self-center">
                    <a href="#"><img src="{{asset('img/arrow_left.png')}}"></a>
                </div>

                <div class="col-10">
                    <h5 class="text-center mb-3 mt-3">{{__('Introduction')}}</h5>
                    ...
                    <h5 class="text-center mb-3 mt-3">{{__('Components')}}</h5>
                    ...
                    <h5 class="text-center mb-3 mt-3">{{__('How to start the game')}}</h5>
                    ...
                    <h5 class="text-center mb-3 mt-3">{{__('How to play cards')}}</h5>
                    ...
                    <h5 class="text-center mb-3 mt-3">{{__('Start and end of the game')}}</h5>
                    ...
                    <nav class="pt-5">
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{route('rules2.index', app()->getLocale())}}">{{__('Next')}}</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="col-1 d-none d-md-block float-end align-self-center">
                    <a href="{{route('rules2.index', app()->getLocale())}}"><img src="{{asset('img/arrow_right.png')}}"></a>
                </div>
            </div>
        </div>
    </section>
